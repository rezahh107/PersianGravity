...
PersianGravity 4.3.0 exposes six bounded, source-defined modules. All default to enabled, including on upgrade when `pgr_modules` does not yet exist:
