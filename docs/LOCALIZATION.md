...
- GravityView retains its separately bounded existing authority; this Gravity Forms change does not broaden GravityView content or script activation.

Validated content authority is the exact union of committed admission records. Gravity Forms and Gravity Flow are revision-3 full-product authorities: Gravity Forms is 1759 historical + 2448 reviewed remainder = 4207/4207, and Gravity Flow remains 732 historical + 366 reviewed remainder = 1098/1098. GravityView remains revision-2 partial authority. Product/source identity alone is never authority. All product script maps remain empty; Gravity Forms and Gravity Flow activate zero native JS translation handles and generate no provider translation JSON. Missing identities in products that remain partial retain upstream/vendor/TranslationsPress fallback and then source English. Full-product content admission is a translation-content claim; representative licensed runtime evidence is reported separately in `docs/VALIDATION.md`.
