...
Root catalog files serve the `persian-gravityforms` own-plugin text domain in 4.5.0. The separate `providers/` tree contains bounded generic `fa_IR` overlay sources and build metadata.
