...
$manifest = array(
	...
	'versions'                        => $versions,
	'source_authority_message_count' => $remainder_evidence['canonical_message_count'],
	'source_authority_keyset_sha256' => $remainder_evidence['canonical_keyset_sha256'],
	'runtime_provider_message_count' => $tested_count,
	'runtime_provider_keyset_sha256' => hash( 'sha256', implode( "\n", $ids ) . "\n" ),
